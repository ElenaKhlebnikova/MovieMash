...
function Genres({ genre }) {
  //  You probably knew I will comment on this lol
  // so this logic can be extracted to a function that uses `switch` and based on the genre ID you can return the correct className as a string
  // and then call this function in the className prop in the dev

  // Maybe another comment, to make this code more readable is use the name of the genre so
  // if someone is reading your code will know that you for example assigned genre "comedy" color blue and so on.
  return (
    <div
